var app = (function () {
    ...
    /* src\ProgressBar.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1gfcxe2");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1gfcxe2");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	progressbar = new ProgressBar({
    			props: { progress: /*progressPer*/ ctx[2] }
    		});
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*progressPer*/ 4) progressbar_changes.progress = /*progressPer*/ ctx[2];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			$$invalidate(2, progressPer = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondsLeft, isRunning, progressPer, startTimer];
    }
    ...
    /* src\HowTo.svelte generated by Svelte v3.37.0 */
